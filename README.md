...
Imagine you wrote tests for the [sweet shop app](https://sweetshop.netlify.com/) (v1) and then some [changes were made a week later](https://sweetshopv2.netlify.com/) (v2) which included bugs. Some of these bugs are functional bugs and some of them are visual bugs.
